...
export class TimeStudyTreeLayout {
  constructor(type, scaling = 1) {
    ...
    this.rows.push(
      ...
      normalRow(TimeStudy.metaDimensions),
      normalRow(TimeStudy.masteryStudies),
    );
...
export const STUDY_TREE_LAYOUT_TYPE = {
  ...
  get current() {
    ...
    if (alt62 && alt181) {
      return this.ALTERNATIVE_62_181;
    }
    if (alt62) {
      return this.ALTERNATIVE_62;
    }
    if (alt181) {
      return this.ALTERNATIVE_181;
    }
    return this.NORMAL;
  },
};
