...
GameDatabase.celestials.descriptions = [
  {
    ...
    effects() {
      ...
      You gain less Infinity Points and Eternity Points (x^${
        format(0.55, 2, 2)
      }).`;
    },
  },
  {
    ...
    effects() {
      ...
      Glyph levels are temporarily capped to ${
        formatInt(Effarig.glyphLevelCap)
      }, rarity is unaffected.`;
    },
    description() {
  ...
  },
  {
    ...
    effects() {
      ...
      Infinity, Time, and 8th Antimatter Dimension purchases are limited to ${
        formatInt(1)
      } each.
      ...
      Stored game time is discharged at a reduced effectiveness (exponent^${
        format(0.55, 2, 2)
      }).`;
    },
  },
  ...
  },
  {
    ...
    effects() {
      return `You only have ${
        formatInt(4)
      } Dimension Boosts and can not gain any more.
  ...
  },
  {
    ...
    effects() {
      ...
      Game speed is reduced to ${formatInt(1)} and gradually comes back over ${
        formatInt(10)
      } minutes.
    ...
    description() {
      ...
      and you gain a reward based on how quickly you reached ${
        formatPercents(1)
      }.
      Destabilizing the Reality in less than ${
        formatInt(30)
      } seconds makes it become significantly more difficult,\
      in exchange for giving a much stronger reward.\
      Doing this ${formatInt(8)} times will also give a ${
        formatX(8)
      } to Dark Energy gain.`;
    },
  },
