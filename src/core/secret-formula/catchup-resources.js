...
export const catchupResources = [
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.PRE_INFINITY,
    description:
      `Dimension Boosts are gained by resetting all your Antimatter Dimensions and tickspeed after
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.PRE_INFINITY,
    description:
      `Antimatter Galaxies are gained by resetting your Antimatter Dimensions and Dimension Boosts. They
  ...
  },
  {
    ...
    description: () =>
      `Infinity is the first main reset layer. Reaching ${
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.EARLY_INFINITY,
    description: () =>
      `Challenges require you to reach ${
        format(Number.MAX_VALUE, 2)
      } antimatter under more difficult
  ...
  },
  {
    ...
    description: () =>
      ...
      ${
        format(Number.MAX_VALUE, 2)
      } antimatter, giving increasing amounts of Infinity Points with more antimatter.`,
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.BREAK_INFINITY,
    description:
      `Infinity Dimensions Produce in a cascading fashion like Antimatter Dimensions. The lowest tier of
  ...
  },
  {
    ...
    description: () =>
      ...
      ${
        format(Number.MAX_VALUE, 2)
      }. Completing them rewards upgrades and production boosts.`,
  },
  {
    name: "Replicanti",
    id: 11,
    ...
    description: () =>
      ...
      Infinity Dimensions. At ${
        format(Number.MAX_VALUE, 2)
      } Replicanti, they can be reset to ${formatInt(1)} for an
  ...
  },
  {
    ...
    description: () =>
      `Eternity is the second main reset layer. Reaching ${
        format(Number.MAX_VALUE, 2)
      } Infinity Points
  ...
  },
  {
    ...
    description: () =>
      `Reality is the third and final main reset layer. Reaching ${
        format(DC.E4000)
      } Eternity Points
  ...
  },
  {
    ...
    description:
      `Teresa is the first Celestial, who has a more difficult Reality which gives a massive boost to Glyph
  ...
  },
  {
    ...
    description:
      `Effarig is the second Celestial, whose Reality limits your Glyphs and has scaling nerfs but gives
  ...
  },
  {
    ...
    description:
      `The Nameless Ones are the third Celestial, whose Reality is extremely punishing with a long list of
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.ENSLAVED,
    description:
      `Your Black Hole has the ability to store time in two ways. Charging it allows you to hold on to
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.ENSLAVED,
    description:
      `Infinity Dimensions cannot be purchased indefinitely and all but the 8th have a hard limit for how
  ...
  },
  {
    ...
    description:
      `V is the fourth Celestial, with a modified Reality which is similar to Teresa's Reality but only gives
  ...
  },
  {
    ...
    description:
      `Ra is the fifth Celestial, with a modified Reality which produces a resource called Memory Chunks
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.RA,
    description:
      `Ra has the previous four Celestials under their control, producing Memories over time based on Memory
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.RA,
    description:
      `Teresa's Memories allow you to charge your Infinity Upgrades, maintaining a similar effect but
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.RA,
    description:
      `Effarig's Memories unlock Glyph Alchemy, which gives many minor boosts using a modified version of
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.RA,
    description:
      `Nameless's Memories amplify charging so that the amount of game time stored is larger than the actual
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.RA,
    description:
      `V's Memories unlocks a modified version of V's original Reality with even harder goals and a new set
  ...
  },
  {
    ...
    description: () =>
      `Imaginary Machines are a new resource unlocked when reaching ${
        format(DC.E1000)
      } Reality
  ...
  },
  {
    ...
    description:
      `Lai'tela is the sixth Celestial, whose Reality has a modified completion condition and gives a
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.LAITELA,
    description:
      `Continuum is a modified type of production which allows your Antimatter Dimensions to produce as if
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.LAITELA,
    description:
      `Dark Matter Dimensions are cascading production which operate on a tick-based system instead of
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.LAITELA,
    description:
      `Dark Matter Dimensions can be reset in two ways. Annihilation resets all your Dimensions in exchange
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.LAITELA,
    description:
      `Dark Energy can be used to produce Singularities, which give boosts based on their total amount.
  ...
  },
  {
    ...
    description:
      `Pelle is the seventh and final Celestial, who permanently Dooms your game, throwing you into a very
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.PELLE,
    description:
      `Armageddon is a Pelle-specific reset which you can perform at any time. This resets your progress to
  ...
  },
  {
    ...
    requiredStage: PROGRESS_STAGE.PELLE,
    description:
      `Upon reaching certain progress milestones within Pelle, a Strike may occur which permanently applies
