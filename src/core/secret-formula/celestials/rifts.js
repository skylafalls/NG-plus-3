  ...
  vacuum: {
    ...
    effect: (totalFill) => {
      if (player.challenge.eternity.current !== 0) {
        ...
        const goal = chall.goalAtCompletions(
          chall.gainedCompletionStatus.totalCompletions,
        );
    ...
    milestones: [
      {
        ...
        requirement: 0.04,
        description:
          "You can equip a single basic Glyph with decreased level and rarity",
      },
      {
        resource: "vacuum",
        requirement: 0.06,
        description: () =>
          `Uncap Replicanti and make its unlock and upgrades ${
            formatX(1e130)
          } cheaper`,
        effect: () => 1e130,
      },
      {
        ...
        requirement: 0.4,
        description: () =>
          `${wordShift.wordCycle(PelleRifts.vacuum.name)} also affects EP gain`,
        effect: () =>
          Decimal.pow(
            4,
    ...
    galaxyGeneratorText:
      "There is not enough space left for more, you must fill in the $value",
  },
  decay: {
    id: 2,
    key: "decay",
    ...
    milestones: [
      {
        ...
        requirement: 0.2,
        description:
          "First rebuyable Pelle upgrade also affects 1st Infinity Dimension",
        effect: () => {
      ...
      },
      {
        ...
        requirement: 0.6,
        description: () =>
          `When Replicanti exceeds ${format(DC.E1300)},
      ...
      },
      {
        ...
        requirement: 1,
        description:
          "Increase max Replicanti Galaxies based on total Rift milestones",
        effect: () => {
    ...
    galaxyGeneratorText:
      "There's not enough antimatter to form new Galaxies, you need to reverse the $value",
  },
  chaos: {
    id: 3,
    key: "chaos",
    ...
    effect: (totalFill) => {
      ...
      return Decimal.pow(
        6,
        Decimal.pow(6, Decimal.pow(6, fill / 10 + 0.1)).minus(6),
      )
        .div(1e5)
    ...
    milestones: [
      {
        ...
        requirement: 0.09,
        description: () =>
          `${wordShift.wordCycle(PelleRifts.decay.name)} \
      ...
      },
      {
        ...
        description: () =>
          `You gain ${
            formatPercents(0.01)
          } of your EP gained on Eternity per second`,
      },
    ],
    galaxyGeneratorText:
      "Your Galaxies are too fragmented, you must stabilize the $value",
  },
  recursion: {
    id: 4,
    key: "recursion",
    ...
    galaxyGeneratorText:
      "Creating more Galaxies is unsustainable, you must focus the $value to allow more",
  },
  paradox: {
    id: 5,
    key: "paradox",
    ...
    milestones: [
      {
        ...
        requirement: 0.15,
        description:
          "Time Dimensions 5-8 are much cheaper, unlock more Dilation upgrades",
      ...
      },
      {
        ...
        requirement: 0.25,
        description: () =>
          `Dilated Time gain becomes Tachyon Particles ${formatPow(1.4, 1, 1)}`,
        effect: 1.4,
      },
      {
        resource: "paradox",
        requirement: 0.5,
        description:
          "Dilation rebuyable purchase count improves Infinity Power conversion rate",
        effect: () =>
          Decimal.min(
            Decimal.pow(
              1.1075,
              Object.values(player.dilation.rebuyables).sum().sub(60),
            ),
            712,
          ).toNumber(),
    ...
    galaxyGeneratorText:
      "It should be possible to create more, but Pelle has restricted you. Disregard the $value",
  },
};
