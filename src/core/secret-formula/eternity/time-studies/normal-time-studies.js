...
const passiveIPMult = () => {
  const isEffarigLimited = Effarig.isRunning
    && Effarig.currentStage === EFFARIG_STAGES.ETERNITY;
...
export const normalTimeStudies = [
  ...
  },
  {
    ...
    description: () =>
      `Improve Replicanti multiplier formula to
  ...
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () =>
      `Base Replicanti interval limit ${formatInt(50)}ms ➜ ${formatInt(1)}ms`,
    effect: 1,
  },
  {
    id: 31,
  ...
  },
  {
    ...
    effect: () =>
      DC.D1_2.pow(
        player.dilation.totalTachyonGalaxies.add(Replicanti.galaxies.total).add(player.galaxies),
      ),
    formatEffect: value => formatX(value, 2, 1),
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () =>
      `Antimatter Galaxy requirement increases by ${formatInt(48)}
  ...
  },
  {
    ...
    requirement: [41, 42],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `You gain ${formatX(1e33)} more Infinity Points`,
    effect: 1e33,
  },
  {
    id: 61,
    ...
    requirement: [51],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `You gain ${formatX(55)} more Eternity Points`,
    effect: 55,
  },
  {
    id: 62,
    ...
    requirement: [
      42,
      () => Perk.bypassEC5Lock.isBought || EternityChallenge(5).completions > 0,
    ],
    reqType: TS_REQUIREMENT_TYPE.ALL,
  ...
  },
  {
    ...
    requirement: [
      61,
      () =>
        Perk.studyECRequirement.isBought || !EternityChallenge(12).isUnlocked,
    ],
  ...
  },
  {
    ...
    requirement: [
      61,
      () =>
        Perk.studyECRequirement.isBought || !EternityChallenge(11).isUnlocked,
    ],
    reqType: TS_REQUIREMENT_TYPE.DIMENSION_PATH,
    description:
  ...
  },
  {
    ...
    effect: () =>
      DC.D2.pow(
        new Decimal(60).div(Decimal.max(Time.bestEternity.totalSeconds, 2)),
      ),
    cap: DC.C2P30,
    formatEffect: value => formatX(value, 2, 1),
  },
  ...
  },
  {
    ...
    effect: () => Decimal.pow(Replicanti.amount, Replicanti.amount.plus(1).log10().plus(1).log10().sqrt()),
    formatEffect: value => formatX(value, 2, 1),
  },
  {
    id: 102,
    ...
    effect: () => Decimal.pow(player.replicanti.galaxies, player.replicanti.galaxies),
    formatEffect: value => formatX(value, 2, 1),
  },
  {
    id: 103,
    ...
    effect: () => player.replicanti.galaxies.plus(1).logPow(3),
  ...
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description:
      () => (Achievement(103).canBeApplied
        ? `Make the Infinity Point formula better log(x)/${
          formatFloat(307.8, 1)
        } ➜ log(x)/${formatInt(280)}`
        : `Make the Infinity Point formula better log(x)/${
          formatInt(308)
  ...
  },
  {
    ...
    description:
      () => (Perk.studyPassive.isBought
        ? `You gain ${formatX(5e10)} more Eternity Points`
        : `You gain ${formatX(350)} more Eternity Points`),
    effect: () => (Perk.studyPassive.isBought ? 5e10 : 350),
  },
  {
    id: 123,
    cost: new Decimal(9),
    ...
    effect: () => {
      const perkEffect = TimeSpan.fromMinutes(
        Perk.studyIdleEP.effectOrDefault(0),
      );
  ...
  },
  {
    ...
    effect:
      () => (Perk.studyActiveEP.isBought
        ? DC.E45
        : DC.E45.divide(thisInfinityMult(Time.thisInfinity.totalSeconds))
            .clampMin(1)),
  ...
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `${formatX(5e25)} multiplier on all Time Dimensions`,
    effect: 5e25,
  },
  {
    id: 161,
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () =>
      `${formatX(DC.E201600)} multiplier on all Antimatter Dimensions`,
    effect: () => DC.E201600,
  },
  {
    id: 162,
    ...
    requirement: [151],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `${formatX(DC.E616)} multiplier on all Infinity Dimensions`,
    effect: DC.E616,
  },
  {
    id: 171,
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () =>
      `Time Shard requirement for the next Tickspeed upgrade goes up slower
  ...
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.ALL,
    description: () =>
      `You gain ${formatPercents(1)} of your Infinity Points gained on crunch each second`,
    effect: () =>
      gainedInfinityPoints().times(Time.deltaTime).timesEffectOf(Ra.unlocks.continuousTTBoost.effects.autoPrestige),
  },
  {
    id: 191,
  ...
  },
  {
    ...
    requirement: [
      181,
      () => EternityChallenge(10).completions > 0,
      () => !Enslaved.isRunning,
    ],
    reqType: TS_REQUIREMENT_TYPE.ALL,
    description:
  ...
  },
  {
    ...
    effect:
      () => (DC.E13000.pow(Currency.eternities.value.div(1e6).clampMax(1))),
    cap: DC.E13000,
    formatEffect: value => formatX(value, 2, 1),
  },
  {
  ...
  },
  {
    ...
    effect: () =>
      Decimal.pow(Currency.timeShards.value.clampMin(2).log2(), 0.006),
  ...
  },
  {
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description:
      "Dimensional Sacrifice boosts the 8th Antimatter Dimension even more",
    effect: () => {
      return Sacrifice.totalBoost.pow(0.5);
    },
    formatEffect: value => formatX(value, 2, 1),
  },
  {
  ...
  },
  {
    ...
    requiresST: [221],
    description: () =>
      `Dimension Boost costs scale by another ${formatInt(2)} less`,
    effect: 2,
  },
  {
    id: 223,
  ...
  },
  {
    ...
    description() {
      ...
      return `Distant Galaxy cost scaling starts ${
        quantifyInt("Galaxy", effect)
      } later
  ...
  },
  {
    ...
    requiresST: [228],
    description:
      "Dimensional Sacrifice affects 4th Time Dimension with reduced effect",
    effect: () => Decimal.max(Sacrifice.totalBoost.plus(1).logPow(0.5), 1),
  ...
  },
  {
    ...
    requiresST: [227],
    description: () =>
      `Dimensional Sacrifice formula scales better
  ...
  },
  {
    ...
    effect: () => Decimal.pow(DimBoost.totalBoosts, 2).clampMin(1),
    formatEffect: value => formatX(value, 2, 2),
  },
  {
    id: 232,
  ...
  },
  {
    ...
    requiresST: [234],
    description:
      "Max Replicanti Galaxy upgrade is cheaper based on current Replicanti",
    effect: () => Replicanti.amount.pow(1.3),
  ...
  // Note: These last 4 entries are the triad studies
  {
    ...
    STCost: 12,
    requirement: [
      () => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 1,
      221,
      222,
      231,
    ],
    ...
    effect: () =>
      TimeStudy(221).effectValue.pow(TimeStudy(231).effectValue.minus(1))
        .clampMin(1),
    formatEffect: value => formatX(value, 2, 1),
  ...
  },
  {
    ...
    STCost: 12,
    requirement: [
      () => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 2,
      223,
      224,
      232,
    ],
    ...
    description: () =>
      `Distant Galaxy scaling threshold starts another ${
        formatInt(3000)
      } Antimatter Galaxies later`,
    effect: 3000,
  ...
  },
  {
    ...
    STCost: 12,
    requirement: [
      () => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 3,
      225,
      226,
      233,
    ],
    ...
    description: () =>
      `Gain ${
        formatPercents(0.5)
      } more extra Replicanti Galaxies from Time Studies 225 and 226,
  ...
  },
  {
    ...
    STCost: 12,
    requirement: [
      () => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 4,
      227,
      228,
      234,
    ],
