...
export const AM = {
  total: {
    ...
    displayOverride: () =>
      `${format(Currency.antimatter.productionPerSecond, 2, 2)}/sec`,
    multValue: () =>
      new Decimal(Currency.antimatter.productionPerSecond).clampMin(1),
    isActive: true,
  ...
  effarigAM: {
    ...
    powValue: () => {
      ...
      const baseProd = ad1.totalAmount.times(ad1.multiplier).times(
        Tickspeed.perSecond,
      );
      return Math.pow(
        baseProd.log10(),
