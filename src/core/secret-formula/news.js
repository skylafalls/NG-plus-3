...
export const news = [
  ...
  {
    id: "a13",
    text: `Electrons are now seeing the happy things in life.
  ...
  },
  {
    ...
    get text() {
      return `Can we get ${
        format(1e169)
      } likes on this video??? Smash that like button!!`;
    },
  },
  {
    id: "a50",
  ...
  {
    id: "a55",
    text: `"As for sure as the sun rises in the west, of all the singers and
  ...
  {
    id: "a87",
    text: `According to no known laws of aviation, there are multiple ways a bee
  ...
  },
  {
    ...
    get text() {
      const games = [
        ...
        {
          name:
            "Mine Defense (the game's ui is broken on https so make sure you're on http!)",
  ...
  {
    id: "a93",
    text: `On a scale of 1 to 10, I rate this game a solid
  ...
  {
    id: "a99",
    text: `"Antimatter has made time travel possible and I'm here to make the
  ...
  {
    id: "a157",
    text: `.tuo ti gnitset fo ssecorp eht ni yltnerruc m'I dna ,rettamitna otni
  ...
  {
    id: "a166",
    text: `<span style='animation: a-game-header__antimatter--glow 2s infinite'>
  ...
  {
    id: "a184",
    text: `<span style='animation: a-text-grow 1s infinite'>R̵̬̙͋͂̀̋͑̈́̇͠Ê̵͇͎͂̂̍̓̌̐̋̋̀̀̔M̶̨̲̯̘͙̬̥̮̣͚̱̫͛̽̃͌̚͝
  ...
  {
    id: "a195",
    text: `Clowns are unique in that there is no such thing as an anti-clown,
  ...
  {
    id: "a218",
    text: `After numerous catastrophic annihilation events, antimatter is
  ...
  },
  {
    id: "a223",
    text:
      "If you find your infinity lasting longer than 5 hours please contact a medical professional.",
    get unlocked() {
      return PlayerProgress.infinityUnlocked();
    },
  },
  ...
  {
    id: "a242",
    text: `"You can come up with the stupidest quote, credit it to some famous
  ...
  },
  {
    ...
    get text() {
      ...
      const reasons = {
        ...
        Dark:
          "it's very easy on the eyes, and has this nice playful tone to it in both the colors and the shapes.",
        DarkMetro:
        ...
        AMOLED:
          "it saves 10% more energy compared to using a light theme. Doesn't everyone love saving energy?",
        AMOLEDMetro:
        ...
        S1:
          "it really gets me in the holiday spirit. I can just feel the magic in the air!",
        S2:
          "it makes me proud to be Finnish, and proud to celebrate all that we have accomplished as a people.",
        S3:
          "it's a beautiful analogue for life, in that it's ever changing and never quite right.",
        S4:
        ...
        S8:
          "it makes it a lot easier to sneak in a little gameplay at the office.",
  ...
  },
  {
    ...
    get text() {
      ...
      for (const set of chasers) {
        ...
        for (let i = 0; i < 3; i++) {
          if (Math.random() > 0.5 || !scene.includes(chaser)) {
            scene += chaser;
          }
        }
        scene += "&nbsp;&nbsp;&nbsp;";
  ...
  },
  {
    id: "a276",
    get text() {
      return `Fun fact: There are ${GameDatabase.news.length} news messages and counting!`;
    },
  },
  {
    id: "a277",
    text: `Inside you there are two wolves. One is made out of matter. The other
  ...
  },
  {
    id: "a289",
    text:
      "Click here to disassemble the news ticker for a trace amount of paperclips.",
    onClick() {
    ...
    get text() {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        if (price === 0) {
          ...
          prices[i] = `<span style="color: red">-${price} ▼</span>`;
        }
      }
  ...
  {
    id: "a311",
    text: `This message has been copyrighted by The Walt Disney Company. Your
  ...
  {
    id: "a324",
    text: `If you have an idea for a news message, shout it into the void.
  ...
  {
    id: "a329",
    text: `Introducing Morse Code+++ - the brand new Morse code, now with 20 new
  ...
  {
    id: "a346",
    text: `Did you know Antimatter Dimensions is also available on Android? <a
  ...
  {
    id: "a359",
    text: `Local incremental game dev makes physicists unhappy again. They claim
  ...
  },
  {
    id: "l1",
    text:
      "You just made your 1,000,000,000,000,000th antimatter. This one tastes like chicken.",
    get unlocked() {
      return Currency.antimatter.value.max(1).log10().eq(15);
    },
  },
  {
    id: "l2",
    ...
    get unlocked() {
      return player.galaxies.eq(2) || Currency.infinities.gt(0);
    },
  },
  {
    id: "l3",
    ...
    get unlocked() {
      return AntimatterDimension(3).amount.gt(0) || DimBoost.totalBoosts.gt(0);
    },
  },
  {
    id: "l4",
    ...
    get unlocked() {
      return AntimatterDimension(8).amount.eq(190) || Currency.infinities.gt(0);
    },
  },
  {
    id: "l5",
  ...
  },
  {
    ...
    get unlocked() {
      return player.galaxies.gt(0) || Currency.infinities.gt(0);
    },
  },
  {
    id: "l7",
  ...
  },
  {
    ...
    get unlocked() {
      return player.requirementChecks.permanent.emojiGalaxies.gt(0);
    },
  },
  {
    id: "l9",
    ...
    get unlocked() {
      return player.records.totalAntimatter.max(1).log10().gt(27);
    },
  },
  {
    id: "l10",
  ...
  },
  {
    ...
    get unlocked() {
      return player.requirementChecks.permanent.emojiGalaxies.gte(5);
    },
  },
  {
    id: "l23",
  ...
  },
  {
    ...
    get unlocked() {
      return Currency.antimatter.value.add(1).log10().gte(100000);
    },
  },
  {
    id: "l30",
    ...
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 30;
    },
  },
  {
    id: "l31",
    ...
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 80;
    },
  },
  {
    id: "l32",
  ...
  },
  {
    ...
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 120;
    },
  },
  {
    id: "l34",
    ...
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 135;
    },
  },
  {
    id: "l35",
    text:
      "Man destroys known universe with antimatter, writes news tickers to keep from feeling lonely.",
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 150;
    },
  },
  {
    id: "l36",
    ...
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 160;
    },
  },
  {
    id: "l37",
    ...
    get unlocked() {
      return NewsHandler.uniqueTickersSeen >= 165;
    },
  },
  {
    id: "l38",
  ...
  },
  {
    ...
    get unlocked() {
      return NewsHandler.hasSeenNews("l1");
    },
  },
  {
    id: "l40",
    ...
    get unlocked() {
      return NewsHandler.hasSeenNews("l58");
    },
  },
  {
    id: "l41",
    ...
    get unlocked() {
      return Time.totalTimePlayed.totalHours.gte(5);
    },
  },
  {
    id: "l42",
  ...
  },
  {
    ...
    get unlocked() {
      return player.records.bestInfinity.time.eq(0.1);
    },
  },
  {
    id: "l44",
    ...
    get unlocked() {
      return player.records.totalAntimatter.max(1).log10().gte(3e6);
    },
  },
  {
    id: "l45",
    ...
    get unlocked() {
      return player.requirementChecks.permanent.emojiGalaxies.gte(3999);
    },
  },
  {
    id: "l46",
  ...
  },
  {
    ...
    get unlocked() {
      return Currency.infinities.gt(2e9);
    },
  },
  {
    id: "l48",
    ...
    get unlocked() {
      return AchievementTimers.marathon1.time.gt(1200);
    },
  },
  {
    id: "l49",
    ...
    get unlocked() {
      return Currency.eternities.gt(50000);
    },
  },
  {
    id: "l50",
    ...
    get unlocked() {
      return Currency.eternities.gt(DC.D2E6);
    },
  },
  {
    id: "l51",
    ...
    get unlocked() {
      return Time.worstChallenge.totalSeconds.lte(1);
    },
  },
  {
    id: "l52",
    text: "Timing is key.",
    get unlocked() {
      return player.records.thisEternity.realTime.lt(10);
    },
  },
  {
    id: "l53",
    text:
      "If you want to farm infinities, why don't you just get the time study?",
    get unlocked() {
      return !TimeStudy(32).isBought && Currency.infinities.gt(72000 * 168);
    },
  },
  {
    id: "l54",
  ...
  },
  {
    id: "l69",
    text:
      "Friendship ended with Replicanti, now Replicanti Galaxies is my new best friend.",
    get unlocked() {
      return PlayerProgress.replicantiUnlocked();
    },
  },
  ...
  },
  {
    ...
    get unlocked() {
      return Player.canEternity || PlayerProgress.eternityUnlocked();
    },
  },
  {
    id: "l72",
  ...
  },
  {
    id: "l73",
    text:
      "A long time ago in a distant galaxy far, far away, the cost scaling changed.",
    get unlocked() {
      return PlayerProgress.eternityUnlocked();
    },
  },
  {
    id: "l74",
    text:
      "Introducing a new feature: Reality Studies! Get in-game benefits for studying in real life!",
    get unlocked() {
      return PlayerProgress.realityUnlocked();
    },
  },
  ...
  },
  {
    id: "l76",
    text:
      "So, you've reached the prestige layer after Infinity? It's about time...",
    get unlocked() {
      return PlayerProgress.eternityUnlocked();
    },
  },
  {
    id: "l77",
    text:
      "Improve your perks through selective breeding and cutting edge epigenetics technology.",
    get unlocked() {
      return PlayerProgress.realityUnlocked();
    },
  },
  ...
  },
  {
    ...
    get unlocked() {
      return Currency.antimatter.value.gte("1e777600");
    },
  },
  {
    id: "l83",
  ...
  },
  {
    ...
    get unlocked() {
      return player.news.specialTickerData.paperclips > 0;
    },
  },
  {
    id: "l85",
  ...
  },
  {
    id: "ai3",
    text:
      "I thought the game was supposed to have a hard reset after eternity, but then I got randomized to start my first game with no save file \uD83D\uDE26",
    get unlocked() {
      return PlayerProgress.eternityUnlocked();
    },
  },
  ...
  },
  {
    id: "ai74",
    get text() {
      return `Ad bonus: $${format(Number.MAX_VALUE, 2)} (random team)`;
    },
  },
  {
    id: "ai75",
  ...
  },
  {
    id: "ai76",
    get text() {
      return `Now releasing: Dimsension ${format(Number.MAX_VALUE, 2)}`;
    },
  },
  {
    id: "ai77",
  ...
  },
  {
    id: "ai112",
    get text() {
      return `This is the last time, to buy items, you must pay a small fee of ${
        format(Number.MAX_VALUE, 2)
      } real money.`;
    },
  },
  ...
  },
  {
    id: "ai244",
    get text() {
      return `The Big Crunch. What could that be?  About 4*1024 Big Crunch points?  About ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai254",
    text:
      "How'd your ⢿─┃│? Good, because today we're having a little chat about the 5th dimension.",
  },
  {
    id: "ai255",
    text:
  ...
  },
  {
    id: "ai308",
    get text() {
      return `If you are reading this, that means ${
        format(Number.MAX_VALUE, 2)
      } matter to you.`;
    },
  },
  ...
  },
  {
    id: "ai312",
    text:
      "IDE for being awesome, ID3 for being dumb, and ID5 for being… well, pretty much the same thing. It's called Antimatter Dimensions for a reason.",
  },
  {
    id: "ai313",
  ...
  },
  {
    id: "ai377",
    get text() {
      return `The year is 1 BILLIONAIRE, the antimatter is 41%, and the dimension is 1e1e8. The standard deviation of a measurement is how small your problems are. This makes people think that the values they are using are general and normal, which leads to many nerfs and even breakdowns. In the year ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai409",
    text:
      "The number of scientific publications based on discrete logarithmic continuity grows exponentially as logarithmic continuity with respect to the antecedent is 9.999626e27.999627 e300 e1.79e308 e²",
  },
  {
    id: "ai410",
    text:
  ...
  },
  {
    id: "ai488",
    get text() {
      return `Welcome and welcome back to another episode of Anti-Fashion Pants, where we watch people's wares as they are sold at stupid clothing stores. This week's subject is... antilasers. People are able to manufacture and use antimatter lasers to shoot antimatter bullets at will, making them able to completely wipe out cities in their sights. This is a dangerous skill to have, as people are not only untrustworthy but also physically incapable of using it. The skill, however, is able to... Produce ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai505",
    text:
      "A long time ago, in an alternate universe, there was an antimatter war. All the antimatter sided with the Phaéton 6 empire. All the antimatter wanted was the low, earth-like ground of the 8th dimension. The anti-infinity won, and the anti-Eternity gained the upper hand. Unfortunately, the anti-Eternity started the war with a sneak attack, and the world exploded. The aftermath has left the landscape of the world in tatters. Far across the world, peasants grow weary as they wait for the harvest. Yet another apocalypse is brewing...",
  },
  {
    id: "ai506",
    text:
  ...
  },
  {
    id: "ai524",
    get text() {
      return `"Help, I'm doomed to fall for the rest of my life" (requires ${
        format(Number.MAX_VALUE, 2)
      } paperclips)`;
    },
  },
  ...
  },
  {
    id: "ai616",
    get text() {
      return `In a recent talk, Yann LeCun said that "A new currency is born." The first incarnation of Antimeta: the currency of the new currency. It's called BTC and it's the difference between 1 and ${
        format(Number.MAX_VALUE, 2)
      }. It's easy to lose your money, since a single bitcoin can't be exchanged for more than ${
        format(Number.MAX_VALUE, 2)
      } BTC.`;
    },
  },
  ...
  },
  {
    id: "ai618",
    text:
      "What if — instead of making news tickers, we could make news tickers that make news tickers?",
  },
  {
    id: "ai619",
    text:
  ...
  },
  {
    id: "ai627",
    get text() {
      return `This mod adds a message that when clicked it disables all your current achievements. This mod also adds a new achievement: you have reached ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai637",
    get text() {
      return `If you are reading this in the AD Server, it's probably best not to bother with the "Matter" achievement. Seriously, what did you think you were doing, anyway, the achievement is fake and wouldn't exist if it weren't for the "you are a worm" achievement. That's a worm achievement, you get one every ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai642",
    get text() {
      return `I'm confused why the game doesn't just give you a [REDACTED] when you get ${
        format(Number.MAX_VALUE, 2)
      } antimatter.`;
    },
  },
  ...
  },
  {
    id: "ai683",
    text:
      "Positrons are a strange little metal that have odd electrical properties. They're commonly found in the form of a roundabout, but they also happen to be, well… positrons.",
  },
  {
    id: "ai684",
  ...
  },
  {
    id: "ai717",
    get text() {
      return `I'd say our odds of seeing a seventh dimension are about 1 in ${
        format(Number.MAX_VALUE, 2)
      }`;
    },
  },
  ...
  },
  {
    id: "ai735",
    get text() {
      return `Antimatter is absolutely and totally rare. Of the ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai746",
    text:
      "The book of archeology is upon us! With over 5 hours of content, it's gonna be a long one! —DIO",
  },
  {
    id: "ai747",
    text:
  ...
  },
  {
    id: "ai748",
    get text() {
      return `Somebody: "What do you mean, 4 is more than 2?" Me: "Well, I mean, 4 is ${
        format(Number.MAX_VALUE, 2)
      }, 2 is 2, etc..."`;
    },
  },
  ...
  },
  {
    id: "ai845",
    text:
      "A new cryptocurrency, called ΔX, has been found. It has the potential to change everything about how we live our lives, and the world. However, it has one major flaw: it has a flaw for the people.",
  },
  {
    id: "ai846",
    text:
  ...
  },
  {
    id: "ai855",
    get text() {
      return `Is the Big Crunch the end of the world? No, it's the beginning of a new era. The era will last for ${
        format(Number.MAX_VALUE, 2)
      } days.`;
    },
  },
  {
    id: "ai856",
    text:
      "The only 'right' way to play a game is to not play at all, right? That's what anti-jokes are all about. — Anti-joker",
  },
  {
    id: "ai857",
    text:
  ...
  },
  {
    ...
    get unlocked() {
      return Currency.infinityPoints.gte(33333333);
    },
  },
  {
    id: "ai882",
  ...
  },
  {
    id: "ai925",
    get text() {
      return `The time has come to reveal the next expansion for Antimatter Dimensions: the ${
        format(Number.MAX_VALUE, 2)
      }th Dimension. It will be released in -5 hours, it costs ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    ...
    get text() {
      return `It's the year ${
        format(Number.MAX_VALUE, 2)
      }, Hevi is still trying to figure out how to fix the update.`;
    },
  },
  {
    id: "ai941",
  ...
  },
  {
    id: "ai964",
    get text() {
      return `Although the majority of players would say that the 9th dimension is not a thing, a handful of people would go and level it up in the most epic way imaginable. These people would use the power of the 9th dimension and achieve, like, ${
        format(Number.MAX_VALUE, 2)
  ...
  },
  {
    id: "ai997",
    get text() {
      return `The intergalactic antimatter trade has been severely disrupted, trading entire galaxies for the occasional paperclip. Cargo stands are no longer used. Oddly enough, the entire dimension has become a dumping ground for discarded plastic and other useless garbage. It's almost as if the rest of the multiverse isn't producing enough good  antiparticles to feed the growing population. Unfortunately, the situation is forcing the entire multiverse to scramble to find ways to meet the growing needs of the antimatter-eating  dev, who claims to have over ${
        format(Number.MAX_VALUE, 2)
