export const progressStages = [
   ...
   */
  {
    ...
    subProgressValue: save =>
      0.33 * save.galaxies + 0.02 * save.dimensionBoosts
  ...
  },
  {
    ...
    subProgressValue: save =>
      Math.clampMax(new Decimal(save.infinities).toNumber(), 500) / 1000
  ...
  },
  {
    ...
    suggestedResource: "Infinity Points",
    subProgressValue: save =>
      Math.sqrt(new Decimal(save.infinityPoints).log10() / 145),
  },
  {
    ...
    suggestedResource: "Infinity Points",
    subProgressValue: save =>
      Math.sqrt((new Decimal(save.infinityPoints).log10() - 140) / 170),
  },
  {
    ...
    subProgressValue: save =>
      new Decimal(save.eternities).clampMax(1e5).toNumber() / 1e5,
  },
  {
    ...
    subProgressValue: save =>
      0.008
      * Object.values(save.eternityChalls).reduce((sum, c) => sum + c, 0)
  ...
  },
  {
    ...
    subProgressValue: save =>
      new Decimal(save.dilation.dilatedTime).log10() / 15,
  },
  {
    ...
    suggestedResource:
      () => (new Decimal(player.eternityPoints).log10().gt(4000)
    ...
    subProgressValue: save =>
      Math.clampMax(
        Math.sqrt((new Decimal(save.eternityPoints).log10() - 1300) / 6700),
        1,
      ),
  },
  {
    ...
    suggestedResource: () => {
      if (player.realities.gt(5)) {
        return "Reality Machines";
      }
      const suffix
        = "in your current Reality, and your Reality Machines in the long term";
      if (player.eternities.eq(0)) {
        return `Infinity Points ${suffix}`;
      }
      if (player.dilation.dilatedTime.eq(0)) {
        return `Eternity Points ${suffix}`;
      }
  ...
  },
  {
    ...
    subProgressValue: save =>
      Math.log10(1 + save.celestials.teresa.pouredAmount) / 21,
  },
  {
    ...
    subProgressValue: save =>
      Math.log10(1 + save.celestials.effarig.relicShards) / 14,
  },
  {
    ...
    subProgressValue: save =>
      Math.sqrt((new Decimal(save.reality.realityMachines).log10() - 30) / 30),
  },
  {
    id: PROGRESS_STAGE.V,
    ...
    subProgressValue: save =>
      0.0277 * Object.values(save.celestials.v.runUnlocks)
  ...
  },
  {
    ...
    subProgressValue: save =>
      Object.values(save.celestials.ra.pets).reduce(
        (sum, pet) => sum + pet.level,
        0,
      ) / 100,
  },
  {
  ...
  },
  {
    ...
    subProgressValue: save =>
      new Decimal(save.celestials.laitela.darkMatter).log10() / 308.25,
  },
  {
    ...
    subProgressValue: save =>
      Math.log10(1 + save.celestials.pelle.remnants) / 9,
  },
];
