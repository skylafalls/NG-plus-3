  ...
  PlayFab._internalSettings = {
    ...
    GetServerUrl: function () {
      if (!(PlayFab.settings.productionServerUrl.substring(0, 4) === "http")) {
        if (PlayFab._internalSettings.verticalName) {
          return "https://" + PlayFab._internalSettings.verticalName +
            PlayFab.settings.productionServerUrl;
        } else {
          return "https://" + PlayFab.settings.titleId +
            PlayFab.settings.productionServerUrl;
        }
      } else {
    ...
    InjectHeaders: function (xhr, headersObj) {
      ...
      for (var headerKey in headersObj) {
        try {
          ...
          console.log(
            "Failed to append header: " + headerKey + " = " +
              headersObj[headerKey] + "Error: " + e,
          );
        }
      }
    },
    ...
    ExecuteRequest: function (
      ...
      var resultPromise = new Promise(function (resolve, reject) {
        ...
        xhr.setRequestHeader(
          "X-PlayFabSDK",
          "JavaScriptSDK-" + PlayFab._internalSettings.sdkVersion,
        );
        if (authkey != null) {
          xhr.setRequestHeader(authkey, authValue);
        }
        PlayFab._internalSettings.InjectHeaders(
          xhr,
        ...
        xhr.onloadend = function () {
          ...
          var result = PlayFab._internalSettings.GetPlayFabResponse(
            request,
            xhr,
            startTime,
            customData,
        ...
        xhr.onreadystatechange = function () {
          if (this.readyState === 4) {
            var xhrResult = PlayFab._internalSettings.GetPlayFabResponse(
              request,
              this,
              startTime,
              customData,
    ...
    UpdateAuthenticationContext: function (authenticationContext, result) {
      ...
      if (result.data.PlayFabId !== null) {
        PlayFab._internalSettings.authenticationContext.PlayFabId =
          result.data.PlayFabId;
        authenticationContextUpdates.PlayFabId = result.data.PlayFabId;
      }
      if (result.data.SessionTicket !== null) {
        PlayFab._internalSettings.authenticationContext.SessionTicket =
      ...
      if (result.data.EntityToken !== null) {
        PlayFab._internalSettings.authenticationContext.EntityId =
          result.data.EntityToken.Entity.Id;
        authenticationContextUpdates.EntityId =
          result.data.EntityToken.Entity.Id;
        PlayFab._internalSettings.authenticationContext.EntityType =
          result.data.EntityToken.Entity.Type;
        authenticationContextUpdates.EntityType =
          result.data.EntityToken.Entity.Type;
        PlayFab._internalSettings.authenticationContext.EntityToken =
      ...
      authenticationContext = Object.assign(
        authenticationContext,
    ...
    ExecuteRequestWrapper: function (
      apiURL,
      request,
      authKey,
      callback,
      ...
      var authValue = null;
      if (authKey !== null) {
        var authInfo = PlayFab._internalSettings.GetAuthInfo(
          request,
          authKey = authKey,
        );
      ...
      return PlayFab._internalSettings.ExecuteRequest(
        PlayFab._internalSettings.GetServerUrl() + apiURL,
        request,
        authKey,
        authValue,
        callback,
...
PlayFab.GenerateErrorReport = function (error) {
  ...
  for (var paramName in error.errorDetails) {
    for (var msgIdx in error.errorDetails[paramName]) {
      fullErrors += "\n" + paramName + ": " +
        error.errorDetails[paramName][msgIdx];
    }
  }
  return fullErrors;
};
...
PlayFab.ClientApi = {
  IsClientLoggedIn: function () {
    return PlayFab._internalSettings.sessionTicket != null &&
      PlayFab._internalSettings.sessionTicket.length > 0;
  },
  ...
  AcceptTrade: function (request, callback, customData, extraHeaders) {
    return PlayFab._internalSettings.ExecuteRequestWrapper(
      "/Client/AcceptTrade",
      request,
      "X-Authorization",
      callback,
  ...
  AddOrUpdateContactEmail: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  AddSharedGroupMembers: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  AndroidDevicePushNotificationRegistration: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ConsumeMicrosoftStoreEntitlements: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ConsumePS5Entitlements: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ConsumePSNEntitlements: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ConsumeXboxEntitlements: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetAllUsersCharacters: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetCharacterLeaderboard: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetCharacterReadOnlyData: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetContentDownloadUrl: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetFriendLeaderboardAroundPlayer: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetLeaderboardAroundCharacter: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetLeaderboardAroundPlayer: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetLeaderboardForUserCharacters: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPhotonAuthenticationToken: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayerStatisticVersions: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromFacebookIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromFacebookInstantGamesIds: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromGameCenterIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromGenericIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromGoogleIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromGooglePlayGamesPlayerIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromKongregateIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromNintendoServiceAccountIds: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromNintendoSwitchDeviceIds: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromPSNAccountIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromSteamIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromTwitchIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetPlayFabIDsFromXboxLiveIDs: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  GetUserPublisherReadOnlyData: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LinkFacebookInstantGamesId: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LinkGameCenterAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LinkGooglePlayGamesServicesAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LinkNintendoServiceAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LinkNintendoSwitchDeviceId: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LoginWithAndroidDeviceID: function (
    request,
    callback,
    customData,
    extraHeaders,
    ...
    request.TitleId = PlayFab.settings.titleId
      ...
      : request.TitleId;
    if (!request.TitleId) throw PlayFab._internalSettings.errorTitleId;
    ...
    var authenticationContext = JSON.parse(
      JSON.stringify(PlayFab._internalSettings.authenticationContext),
    );
    var overloadCallback = function (result, error) {
      if (result != null) {
        ...
        authenticationContext = PlayFab._internalSettings
          .UpdateAuthenticationContext(authenticationContext, result);
      }
      if (callback != null && typeof callback === "function") {
        callback(result, error);
      }
    };
    PlayFab._internalSettings.ExecuteRequestWrapper(
  ...
  LoginWithFacebookInstantGamesId: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LoginWithGooglePlayGamesServices: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LoginWithNintendoServiceAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LoginWithNintendoSwitchDeviceId: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  LoginWithOpenIdConnect: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  RegisterForIOSPushNotification: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  RemoveSharedGroupMembers: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  SendAccountRecoveryEmail: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  SubtractUserVirtualCurrency: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UnlinkAndroidDeviceID: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UnlinkFacebookInstantGamesId: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UnlinkGameCenterAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UnlinkGooglePlayGamesServicesAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UnlinkNintendoServiceAccount: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UnlinkNintendoSwitchDeviceId: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UpdateCharacterStatistics: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UpdateSharedGroupData: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UpdateUserPublisherData: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  UpdateUserTitleDisplayName: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ValidateAmazonIAPReceipt: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ValidateGooglePlayPurchase: function (
    request,
    callback,
    customData,
    extraHeaders,
  ...
  ValidateWindowsStoreReceipt: function (
    request,
    callback,
    customData,
    extraHeaders,
